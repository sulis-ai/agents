...
| WP-003 | Author 2 Trigger instances | create | contract | pending | — | WP-007 | 1k / 1k | FR-007 |
| WP-004 | Author 8 FailureMode instances | create | contract | pending | — | WP-002, WP-006, WP-007, WP-009 | 2k / 3k | FR-008 |
| WP-005 | Author 4 Project instances | create | contract | pending | WP-001 | WP-007 | 2k / 2k | FR-001 |
| WP-006 | Author 17 Tool catalogue (5 primary + 12 stub) | create | contract | pending | WP-004 | WP-002, WP-007 | 4k / 6k | FR-005, ADR-003 |
...
| WP-009 | Add canonical annotations to release-on-merge.yml | extend | infra | pending | WP-002, WP-004 | — | 3k / 1k | ADR-002, FR-012 |
| WP-010 | Extend `/sulis:release-train` for dry-run-walks-canonical | extend | docs | pending | WP-001, WP-002 | — | 4k / 2k | FR-011 |
| WP-011 | Cross-reference Configuration Vocabulary in marketplace README | extend | docs | pending | — | — | 2k / 1k | FR-016, UC-004 |

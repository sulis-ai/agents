...
> `/sulis:verify-architecture`, `/sulis:codebase-assess`, `/sulis:code-review`.
...
| `plugins/sulis/skills/codebase-assess/references/primitives.md` | The 25-primitive catalogue; rows 5–8 of the coverage matrix; tier-2/tier-5/tier-6 candidates. |
...
| **Adversarial human-in-the-loop** | `/investor-coach:adversarial-review` pattern | When the fix is a design decision. Skill produces a perspective; founder accepts/rejects/modifies. |

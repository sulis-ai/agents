...
| WP-003 | Add the back-merge step block to the reusable workflow (pin-read + decide+act + post-condition) | extend | EXPAND | infra | done | WP-002 | WP-005, WP-009 | 4k / 4k | §4.2; §5.2; §5.3; §5.6; §5.7 |
...
| WP-005 | Replace marketplace's `.github/workflows/release-on-merge.yml` with a shim (n=1 dogfood) | substitute-replace | SUBSTITUTE | infra | done | WP-002, WP-003, WP-004 | WP-009 | 2k / 2k | §4.2 comp-marketplace-shim; §6.5; §9.1 |

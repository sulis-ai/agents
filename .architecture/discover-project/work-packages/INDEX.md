...
| WP-003 | Implement Detect phase — RepoInspector port + LocalFilesystemInspector adapter | create | backend | in_progress | WP-001 | WP-008 | 4k / 4k | Form Ports #1; Armor External deps (git CLI) |
| WP-004 | Implement Infer phase — ConfigurationInferrer port + LLM and Null adapters + token budget | create | backend | in_progress | WP-001 | WP-008 | 4k / 4k | Form Ports #2; Armor External deps (LLM); ADR-006 |

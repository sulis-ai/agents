...
│   ├── ports/              # ChangeStoreReader + RecreateRunner (WP-004) + SessionBridge (the chat seam, WP-005) + ConversationIdentity (the assisted-origin seam: resolved session → Thread id + Message ordinal, ADR-016/018)

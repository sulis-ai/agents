...
// WP-003 — the cold-start example chips (from the SIGNED visual contract,
...
export function StartFromIntent({
  ...
  // WP-003 — tapping a cold-start chip prefills the intent box (the existing
  ...
  return (
    <section className={styles.frontdoor} aria-label="Start from intent">
      <div className={styles.scroll}>
        ...
        {/* WP-003 — the cold-start empty state: a soft welcome + example chips,
            shown only before the founder has typed anything (the one genuinely
            new piece of the start screen; ADR-001 — inside this component, not a
            new surface). */}
        {showColdStart && (

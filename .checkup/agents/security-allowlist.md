...
gitleaks::generic-api-key::plugins/sea/skills/probe/tests/unit/test_credential_runner.py::46: sea:probe test fixture
gitleaks::generic-api-key::plugins/sea/skills/probe/tests/unit/test_credential_runner.py::59: sea:probe test fixture
gitleaks::generic-api-key::plugins/sea/skills/probe/tests/unit/test_credential_runner.py::180: sea:probe test fixture
...
# semgrep::python.lang.security.use-defused-xml.use-defused-xml::plugins/sea/skills/probe/scripts/probe/workspace.py::40 — XXE vuln; needs defusedxml swap
# semgrep::python.lang.security.use-defused-xml-parse.use-defused-xml-parse::plugins/sea/skills/probe/scripts/probe/workspace.py::269 — XXE vuln; needs defusedxml swap
